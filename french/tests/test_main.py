...
SAMPLE_DIR = FRENCH_DIR / "sample_files"
...
class GeminiValidationTests(unittest.TestCase):
        ...
        result = [
            {
                ...
                "french_translation": "Je l’ai rencontré.",
            },
            {
                "row_id": self.records[0].row_id,
                "french_translation": "Votre détective privé,//Ronak... - Oui.",
            },
        ]
    ...
    def test_changed_line_break_markers_are_rejected(self):
        result = [
            {
                "row_id": self.records[0].row_id,
                "french_translation": "Ce marqueur a été supprimé.",
            },
            {
                "row_id": self.records[1].row_id,
                "french_translation": "Je l’ai rencontré.",
...
class EndToEndWorkbookTests(unittest.TestCase):
    def test_sample_output_preserves_rows_and_adds_french_column(self):
        context = main.load_supporting_context(
            character_list_path=CHARACTER_LIST,
            episode_synopsis_path=EPISODE_SYNOPSIS,
            series_synopsis_path=SERIES_SYNOPSIS,
            ...
            return [
                {
                    ...
                    "french_translation": f"FR: {record.english_subtitle}",
                }
        ...
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            self.assertEqual(output_sheet.cell(2, 8).value, main.FRENCH_HEADER)
            self.assertEqual(
                output_sheet.cell(4, 8).value,
                "FR: Your private investigator,//Ronak... - Yes.",
            )
